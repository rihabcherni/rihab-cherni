    ...
    projectsListe:[
        {
            title: "Mini-Docto+",
            description:
            "Plateforme facilitant la mise en relation entre patients et professionnels de santé via web et mobile. Backend Node.js + MongoDB, frontend React.js et mobile Flutter.",
    ...
    projectsListe: [
        {
            title: "Mini-Docto+",
            description:
            "Platform connecting patients and healthcare professionals via web and mobile. Node.js + MongoDB backend, React.js web frontend, Flutter mobile app.",
            tech: ["React.js", "Flutter", "Node.js", "MongoDB", "Express", "Tailwind CSS", "JWT", "Axios"],
            link: "https://github.com/rihabcherni/mini-docto",
            linkweb: "https://mini-docto.vercel.app/",
            date: "2025",
    ...
    projectsListe: [
        {
            title: "Mini-Docto+",
            description:
            "منصة تربط بين المرضى والمتخصصين في الرعاية الصحية عبر الويب والتطبيقات المحمولة. Backend بـ Node.js + MongoDB، واجهة ويب React.js، وتطبيق جوال Flutter.",
            tech: ["React.js", "Flutter", "Node.js", "MongoDB", "Express", "Tailwind CSS", "JWT", "Axios"],
            link: "https://github.com/rihabcherni/mini-docto",
            linkweb: "https://mini-docto.vercel.app/",
            date: "2025",
        ...
        },
        {
          ...
          description:
            'تطوير الموقع الرسمي IEEE RAS تونس (RTC)، يعرض المعلومات الرئيسية، المتحدثين، البرنامج ونموذج التسجيل عبر الإنترنت.',
          tech: ['HTML', 'CSS', 'JavaScript', 'PHP', 'Bootstrap'],
          link: 'https://github.com/rihabcherni/ieee-ras-event',
          linkweb:'https://ieee-ras-event.onrender.com/',
          date: 'أغسطس 2025',
